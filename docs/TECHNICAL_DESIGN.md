...
Generated by ChatGPT. This needs to be verified for accuracy.

| Name | Version | License | Purpose |
| --- | --- | --- | --- |
| [github.com/golang-jwt/jwt](https://github.com/golang-jwt/jwt) | v3.2.2+incompatible | - | JSON Web Token implementation for Go. |
| [github.com/google/uuid](https://github.com/google/uuid) | v1.6.0 | - | Implementation of Universally Unique Identifier (UUID) in Go. |
...
| [golang.org/x/crypto](https://golang.org/x/crypto) | v0.21.0 | - | Additional cryptography packages for Go. |
